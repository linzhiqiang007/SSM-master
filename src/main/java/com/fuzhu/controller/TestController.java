...
//        scoreService.insertScore(score);
    ...
    @RequestMapping(value = "/testMethod1",produces="text/html;charset=UTF-8", method = {RequestMethod.GET,RequestMethod.GET})
    public String test2() {
        logger.info("TestController: " + " 这是我的测试类(请忽视) ~ …… ~ ！！！ " + new Date());
        Score score = new Score();
        score.setChangeType("玩游戏");
        score.setScore(10);
        scoreService.insertScore(score);
