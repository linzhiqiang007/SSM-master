...
public class UserServiceImpl implements UserService {
    ...
    public List<Score> FindAll() {
        List<Score> userScores = userDao.FindAll();
        System.out.println(userScores.toString());
        return userScores;
    }

    @Override
    public List<Score> FindAllByAccount(String account) {
        List<Score> userScores = userDao.FindAllByAccount(account);
        System.out.println(userScores.toString());
        return userScores;
    }

    @Override
    public long getFindUserByaccoutAndPassword(User user) {
        long count = (long) userDao.getFindUserByaccoutAndPassword(user);
